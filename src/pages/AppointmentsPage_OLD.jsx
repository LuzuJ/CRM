...
const AppointmentsPage = () => {
  ...
  const handleCreateAppointment = async () => {
    ...
    if (targetCase && targetCase.status === 'BLOQUEADO_LEGAL') {
      showToast('No se puede agendar citas para un trámite con impedimentos legales pendientes', 'error');
      return;
    }

    try {
      showToast('Funcionalidad de citas no disponible en el backend', 'warning');
      // TODO: Implementar cuando el backend tenga endpoint de citas
      ...
      showToast('Error al crear la cita: ' + error.message, 'error');
    }
  };
